...
class CocoDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.data_format == 'zip':
            raise NotImplementedError("add zipreader if you want zip")
    ...
    def evaluate(self, preds, scores, output_dir,
                 dataset_with_center, test_ignore_center):
        '''
        ...
        for idx, _kpts in enumerate(preds):
            ...
            for idx_kpt, kpt in enumerate(_kpts):
                ...
                if dataset_with_center and not test_ignore_center:
                    kpt = kpt[:-1]

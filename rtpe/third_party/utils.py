...
def create_logger(name, out_dir, log_dir="log", phase='train'):
    """
    """
    logger, time_str = setup_logger(out_dir, 0, phase)
    tensorboard_log_dir = os.path.join(log_dir, name + '_' + time_str)

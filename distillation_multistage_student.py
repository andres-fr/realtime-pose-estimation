...
#
from rtpe.students import MultistageStudent
...
student = MultistageStudent(MODEL_PATH, DEVICE, LAYERS_PER_STAGE,
...
for epoch in range(NUM_EPOCHS):
    for (img_id, imgs, masks, hms, teach_hms, teach_aes) in train_dl:
        ...
        # # preds = student(imgs)
        # # DUMMY_TARGETS = torch.zeros_like(preds)
        # # batch_loss = TEST_LOSS(preds, DUMMY_TARGETS)
